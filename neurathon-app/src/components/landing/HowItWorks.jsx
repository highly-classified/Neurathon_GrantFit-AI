...
const HowItWorks = () => {
  return (
    <section id="how-it-works" className="py-24 relative overflow-hidden bg-[#0a0f1c]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-[var(--color-primary)]/20 via-[var(--color-secondary)]/50 to-[var(--color-primary)]/20 -translate-y-1/2"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
            {steps.map((step, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-gray-800 border-4 border-[var(--color-background)] z-10 flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(139,92,246,0.3)] group-hover:scale-110 transition-transform duration-300">
